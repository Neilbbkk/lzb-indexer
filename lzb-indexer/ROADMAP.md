...
- Docker Desktop Settings → Resources → Proxies 配 [http://127.0.0.1:7897](http://127.0.0.1:7897)
...
**位置：** D:\lzkcomp\web3\lzb-indexer **技术栈：** Java 8 + Maven 3.8 + Spring Boot 2.7.18 + Web3j 4.9.8 + PostgreSQL + H2(test)
...
| ----------- | ---- | ------------------------------------------------- |
| postgres    | 5432 |                                                   |
| pgadmin     | 5050 | [admin@admin.com](mailto:admin@admin.com) / admin |
